...
// Rebuild the API_KEYS object using clean environment variables
const API_KEYS = {
  client1: process.env.CLIENT_ONE,
  client2: process.env.CLIENT_TWO,
  // You can easily add more here later:
  // client3: process.env.CLIENT_THREE
};

// Double-check that at least your primary client key is loaded
if (!API_KEYS.client1) {
