...
const NAV_ITEMS = [
  ...
  { label: 'Integrations', icon: Database, href: '/integrations' },
...
export function Sidebar() {
  ...
  // Assume Unity is connected if simulation info exists in status
  ...
  return (
    <aside className="w-[240px] flex-shrink-0 bg-[var(--color-panel-100)] border-r border-[var(--color-border-main)] flex flex-col h-full overflow-hidden">
      <div className="h-14 flex items-center px-4 border-b border-[var(--color-border-main)] shrink-0 gap-2">
        <div className="font-serif text-lg font-bold tracking-wide text-white">XOLTRA</div>
      ...
      <div className="p-3">
        <button className="w-full flex items-center gap-2 px-3 py-2 text-sm text-[var(--color-text-secondary)] bg-[#151515] hover:bg-[#1a1a1a] border border-[var(--color-border-main)] rounded-[var(--radius-global)] transition-colors">
        <button 
